...
from app.routers import valuation_router, momentum_router, portfolio_router, mf_router, fno_router, directional_bias_router
...
app.include_router(directional_bias_router.router)
